...
public class BranchService {
    ...
    /**
     * Creates a new branch from the latest version of the source branch.
     *
    ...
    public VersionDoc createBranchFrom(String modelId, String sourceBranch, String newBranchName, String siteId) {
        ...
        if (sourceBranchVersions.isEmpty()) {
            throw new IllegalArgumentException("Source branch '" + sourceBranch + "' has no versions for model " + modelId);
        }
